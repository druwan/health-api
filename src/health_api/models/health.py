...
class BloodGlucoseSample(HAEBase):
    date: datetime
    qty: Optional[float] = None
    meal_time: Optional[str] = Field(None, alias="mealTime")  # "Before Meal" | "After Meal" | "Unspecified"
    source: Optional[str] = None
...
class WorkoutPayload(HAEBase):
    ...
    heart_rate_recovery: Optional[list[WorkoutHeartRateSample]] = Field(None, alias="heartRateRecovery")
    ...
    walking_running_distance: Optional[list[WorkoutQuantitySample]] = Field(None, alias="walkingAndRunningDistance")
    ...
    total_swimming_stroke_count: Optional[QuantityValue] = Field(None, alias="totalSwimmingStrokeCount")
...
class ECGEntry(HAEBase):
    ...
    voltage_measurements: Optional[list[VoltageMeasurement]] = Field(None, alias="voltageMeasurements")
    source: Optional[str] = None
